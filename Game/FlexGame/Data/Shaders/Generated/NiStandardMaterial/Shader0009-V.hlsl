#line 2 "c:\Users\Tammy\Documents\School\cis499\Flex_code\Game\FlexGame\Data\Shaders\Generated\NiStandardMaterial\Shader0009-V.hlsl"
/*
Shader description:
TRANSFORM = 0
OUTPUTWORLDPOS = 0
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut1, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        VectorOut_CallOut6, g_PointWorldPosition, g_PointAmbient, 
    ...
    Light(WorldPos_CallOut1, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection0, g_MaterialPower, AmbientAccumOut_CallOut8, 
        DiffuseAccumOut_CallOut8, SpecularAccumOut_CallOut8, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut0, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut9, 
