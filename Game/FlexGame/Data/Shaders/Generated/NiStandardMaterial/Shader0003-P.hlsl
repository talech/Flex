#line 2 "c:\Users\Tammy\Documents\School\cis499\Flex_code\Game\FlexGame\Data\Shaders\Generated\NiStandardMaterial\Shader0003-P.hlsl"
/*
Shader description:
APPLYMODE = 1
WORLDPOSITION = 1
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut10, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection0, g_MaterialPower, AmbientAccumOut_CallOut11, 
    ...
    MultiplyFloat3(Specular_CallOut13, ColorOut_CallOut5, Output_CallOut14);
	...
	// Function call #16
    float3 OutputColor_CallOut16;
    CompositeFinalRGBColor(Output_CallOut15, Output_CallOut14, 
        OutputColor_CallOut16);

	// Function call #17
    CompositeFinalRGBAColor(OutputColor_CallOut16, Output_CallOut9, Out.Color0);
