#line 2 "c:\Users\Tammy\Documents\School\cis499\Flex_code\Game\FlexGame\Data\Shaders\Generated\NiStandardMaterial\Shader0001-P.hlsl"
/*
Shader description:
APPLYMODE = 1
WORLDPOSITION = 1
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Specular_CallOut14, ColorOut_CallOut5, Output_CallOut15);

	// Function call #16
    float3 Output_CallOut16;
    MultiplyFloat3(Diffuse_CallOut14, Color_CallOut7, Output_CallOut16);

	// Function call #17
    float4 TexCoordOut_CallOut17;
    ProjectTextureCoordinates(VectorOut_CallOut13, 
        g_EnvironmentMapWorldProjectionTransform0, TexCoordOut_CallOut17);

	// Function call #18
    float3 ColorOut_CallOut18;
    TextureRGBSample(TexCoordOut_CallOut17, EnvironmentMap, bool(false), 
        ColorOut_CallOut18);

	// Function call #19
    float3 Output_CallOut19;
    MultiplyFloat3(ColorOut_CallOut5, ColorOut_CallOut18, Output_CallOut19);

	// Function call #20
    float3 Output_CallOut20;
    AddFloat3(Output_CallOut19, Output_CallOut15, Output_CallOut20);

	// Function call #21
    float3 OutputColor_CallOut21;
    CompositeFinalRGBColor(Output_CallOut16, Output_CallOut20, 
        OutputColor_CallOut21);

	// Function call #22
    CompositeFinalRGBAColor(OutputColor_CallOut21, Output_CallOut9, Out.Color0);
